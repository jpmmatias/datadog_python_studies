...
class HandleRequests(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        statsd.increment('app.http.request.count',
                         sample_rate=1, tags=["env:dev", "app:pythonapp"])
        ...
        statsd.histogram('app.request.time.histogram',
                         response_time, sample_rate=1, tags=["env:dev", "app:pythonapp"])
